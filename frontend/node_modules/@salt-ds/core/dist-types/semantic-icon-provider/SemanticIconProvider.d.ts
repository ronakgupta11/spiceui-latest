...
export declare type SemanticIconMap = {
...
export declare const SemanticIconProvider: ({ iconMap, children, }: SemanticIconProviderProps) => import("react/jsx-runtime").JSX.Element;
export declare const useIcon: () => SemanticIconMap;
